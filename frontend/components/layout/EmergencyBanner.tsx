...
const EmergencyBanner = () => {
  ...
  return (
    <div className="bg-gradient-to-r from-red-600 via-red-500 to-rose-600 text-white py-3 px-4 text-center text-sm relative z-50 shadow-md" id="emergencyBanner">
      <div className="flex flex-col sm:flex-row items-center justify-center gap-1.5 sm:gap-2.5">
        ...
        <span className="text-white/90 text-xs sm:text-sm leading-none">Call</span>
        ...
        <span className="text-white/80 text-xs sm:text-sm"> Med-Nest provides information only, not emergency advice.</span>
      </div>
      <button 
