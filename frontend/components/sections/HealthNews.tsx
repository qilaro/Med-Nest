    ...
    <section className="py-6 sm:py-8">
      <div className="mx-auto max-w-[1024px] px-3 sm:px-0">
        <div className="bg-white rounded-2xl border border-sky-200 shadow-[0_8px_30px_-12px_rgba(0,0,0,0.25)] p-6 sm:p-8">
          <div className="h-1 w-16 bg-gradient-to-r from-teal-400 to-teal-600 rounded-full mb-6" />
          <div className="flex items-end justify-between mb-6 sm:mb-8">
            <div>
              <span className="text-xs font-bold text-teal-600 uppercase tracking-[0.15em]">Stay Informed</span>
              <h2 className="text-2xl sm:text-4xl font-bold leading-tight text-gray-900 mt-1">
                Latest Health News
              </h2>
            </div>
            <Link
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5 sm:gap-6">
            {newsItems.map((item, index) => (
              <a
                ...
                className="group bg-gradient-to-br from-gray-50 to-white rounded-2xl border border-gray-200/80 p-6 sm:p-8 transition-all duration-300 hover:border-teal-200 hover:shadow-[0_12px_35px_-12px_rgba(0,0,0,0.1)] hover:-translate-y-0.5 flex flex-col"
              >
