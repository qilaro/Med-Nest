// Import next company from MedEasy
...
if (!co) { console.log("Usage: npx tsx next.mjs <json>"); process.exit(1); }
...
async function main() {
  ...
  // Delete old brands (main + divisions)
  if (extraIds?.length) {
  ...
  // Delete extra division companies
  if (extraIds?.length) {
