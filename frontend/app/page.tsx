      ...
      <section className="py-12 bg-white">
        ...
        >
          ...
          <div className="relative px-4 md:px-12">
            ...
            <button className="absolute left-0 top-1/2 -translate-y-1/2 w-10 h-10 rounded-full bg-white/80 border border-gray-200 flex items-center justify-center text-gray-400 hover:text-primary hover:bg-white transition-all shadow-sm z-10" aria-label="Previous slide">
            ...
            <button className="absolute right-0 top-1/2 -translate-y-1/2 w-10 h-10 rounded-full bg-white/80 border border-gray-200 flex items-center justify-center text-gray-400 hover:text-primary hover:bg-white transition-all shadow-sm z-10" aria-label="Next slide">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {/* Card 1: Drug Directory */}
              <div className="bg-white rounded-3xl p-8 shadow-lg border border-white hover:border-primary/20 transition-all group">
                <div className="flex justify-center mb-8">
                  <div className="w-full max-w-[12rem] h-10 rounded-full bg-gray-50 border border-gray-100 flex items-center justify-center shadow-inner relative overflow-hidden">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#57B8A6" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="h-6 w-6 relative z-10 group-hover:scale-110 transition-transform duration-300">
                      <path d="m10.5 20.5 10-10a4.95 4.95 0 1 0-7-7l-10 10a4.95 4.95 0 1 0 7 7Z"></path>
                      <path d="m8.5 8.5 7 7"></path>
                    </svg>
                  </div>
                </div>
                <h3 className="text-xl font-bold text-navy mb-4">Drug Directory</h3>
                <p className="text-gray-600 leading-relaxed">
                  Browse 20,000+ prescription & OTC drugs with complete medical information.
                </p>
              </div>
              ...
              <div className="bg-white rounded-3xl p-8 shadow-lg border border-white hover:border-primary/20 transition-all group">
                ...
                <h3 className="text-xl font-bold text-navy mb-4">Interaction Checker</h3>
                <p className="text-gray-600 leading-relaxed">
                  Check for dangerous drug-drug and drug-food interactions instantly.
                </p>
              </div>

              {/* Card 3: Drug Comparison */}
              <div className="bg-white rounded-3xl p-8 shadow-lg border border-white hover:border-primary/20 transition-all group">
                <div className="flex justify-center mb-8">
                  <div className="w-full max-w-[12rem] h-10 rounded-full bg-gray-50 border border-gray-100 flex items-center justify-center shadow-inner relative overflow-hidden">
                    <div className="absolute inset-0 bg-gradient-to-b from-white to-transparent opacity-50"></div>
                ...
                <h3 className="text-xl font-bold text-navy mb-4">Drug Comparison</h3>
                <p className="text-gray-600 leading-relaxed">
                  Compare up to 4 medications side-by-side for informed decisions.
                </p>
              </div>
            </div>
          </div>
