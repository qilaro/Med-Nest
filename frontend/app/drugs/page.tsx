  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#D5E9E7] via-white to-white py-6">
      <div className="max-w-[800px] mx-auto">
        <div className="bg-white rounded-2xl border border-sky-200 shadow-[4px_8px_24px_rgba(0,0,0,0.08),0_12px_40px_-8px_rgba(0,0,0,0.12)] p-6 md:p-8">
            ...
            {[
              ...
              <div key={filter.label} className="relative w-[130px]">
                <select
                  ...
                  className="appearance-none bg-white border border-sky-200 rounded-full px-3 py-1.5 pr-4 text-xs font-medium text-gray-700 cursor-pointer hover:border-teal-300 hover:bg-teal-50 transition-colors focus:outline-none focus:ring-1 focus:ring-teal-200 w-full text-center"
                >
